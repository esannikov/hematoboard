...
- Candidate `543b264d876c…` passed package/schema closure and full release QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
...
- Candidate `3eb1b863bd1e…` passed package/schema closure and full release QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
...
- Candidate `9ae9da988f5a…` passed package/schema closure and full release QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
...
- Candidate `4ac51225d9d8…` passed package/schema closure and full 18-screen QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
...
- Published the verified dashboard package for CASE017 through the simplified hash-closed release command.
- Preserved the existing clinical candidate, UI shell and clinician gate; this release changes no accepted clinical state.

### Verification

- Candidate `fb8cc3a043df…` passed package/schema closure and full 18-screen QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
...
- Published the verified dashboard package for CASE016 through the simplified hash-closed release command.
- Clarified the CASE016 cytogenetic title and graph scope while preserving stable clinical-entity IDs, the clinical candidate and the clinician gate; this release changes no accepted clinical state.

### Verification

- Candidate `d059ea7217d0…` passed package/schema closure and full 18-screen QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
...
- Published the verified dashboard package for CASE011-V2 through the simplified hash-closed release command.
- Updated the verified UI shell for protocol-replay labels while preserving the clinical candidate and clinician gate; this release changes no accepted clinical state.

### Verification

- Candidate `4e0d159c7006…` passed package/schema closure and full 18-screen QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
...
- Published the verified dashboard package for CASE014 through the simplified hash-closed release command.
- Preserved the existing clinical candidate, UI shell and clinician gate; this release changes no accepted clinical state.

### Verification

- Candidate `f3582ffd9475…` passed package/schema closure and full 18-screen QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
...
- Published the verified dashboard package for CASE013 through the simplified hash-closed release command.
- Preserved the existing clinical candidate, UI shell and clinician gate; this release changes no accepted clinical state.

### Verification

- Candidate `70ecc9b036e7…` passed package/schema closure and full 18-screen QA.
- Public index, package, QA receipt, shell fingerprint and authenticity manifest are closed by exact SHA-256.
